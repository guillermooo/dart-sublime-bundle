...
class AnalysisGetErrorsResult(object):
  ...
  def to_json(self):
    result = {}
    result["errors"] = [AnalysisError.to_json(x) for x in self.errors]
    return result
...
class AnalysisGetHoverResult(object):
  ...
  def to_json(self):
    result = {}
    result["hovers"] = [HoverInformation.to_json(x) for x in self.hovers]
    return result
...
class AnalysisGetNavigationResult(object):
  ...
  def to_json(self):
    ...
    result["targets"] = [NavigationTarget.to_json(x) for x in self.targets]
    result["regions"] = [NavigationRegion.to_json(x) for x in self.regions]
    return result
...
class AnalysisFoldingParams(object):
  ...
  def to_json(self):
    result = {}
    result["file"] = self.file
    result["regions"] = [FoldingRegion.to_json(x) for x in self.regions]
    return result
...
class AnalysisHighlightsParams(object):
  ...
  def to_json(self):
    result = {}
    result["file"] = self.file
    result["regions"] = [HighlightRegion.to_json(x) for x in self.regions]
    return result
...
class AnalysisOccurrencesParams(object):
  ...
  def to_json(self):
    result = {}
    result["file"] = self.file
    result["occurrences"] = [Occurrences.to_json(x) for x in self.occurrences]
    return result
...
class AnalysisOverridesParams(object):
  ...
  def to_json(self):
    result = {}
    result["file"] = self.file
    result["overrides"] = [Override.to_json(x) for x in self.overrides]
    return result
...
class CompletionResultsParams(object):
  ...
  def to_json(self):
    ...
    result["results"] = [CompletionSuggestion.to_json(x) for x in self.results]
...
class SearchGetTypeHierarchyResult(object):
  ...
  def to_json(self):
    result = {}
    if hierarchyItems:
      result["hierarchyItems"] = [TypeHierarchyItem.to_json(x) for x in self.hierarchyItems]
    return result
...
class SearchResultsParams(object):
  ...
  def to_json(self):
    result = {}
    result["id"] = self.id
    result["results"] = [SearchResult.to_json(x) for x in self.results]
    result["isLast"] = self.isLast
    return result
...
class EditFormatResult(object):
  ...
  def to_json(self):
    result = {}
    result["edits"] = [SourceEdit.to_json(x) for x in self.edits]
    result["selectionOffset"] = self.selectionOffset
    result["selectionLength"] = self.selectionLength
    return result
...
class EditGetAssistsResult(object):
  ...
  def to_json(self):
    result = {}
    result["assists"] = [SourceChange.to_json(x) for x in self.assists]
    return result
...
class EditGetFixesResult(object):
  ...
  def to_json(self):
    result = {}
    result["fixes"] = [AnalysisErrorFixes.to_json(x) for x in self.fixes]
    return result
...
class EditGetRefactoringResult(object):
  ...
  def to_json(self):
    result = {}
    result["initialProblems"] = [RefactoringProblem.to_json(x) for x in self.initialProblems]
    result["optionsProblems"] = [RefactoringProblem.to_json(x) for x in self.optionsProblems]
    result["finalProblems"] = [RefactoringProblem.to_json(x) for x in self.finalProblems]
    if feedback:
...
class AnalysisErrorFixes(object):
  ...
  def to_json(self):
    ...
    result["fixes"] = [SourceChange.to_json(x) for x in self.fixes]
    return result
...
class LinkedEditGroup(object):
  ...
  def to_json(self):
    result = {}
    result["positions"] = [Position.to_json(x) for x in self.positions]
    result["length"] = self.length
    result["suggestions"] = [LinkedEditSuggestion.to_json(x) for x in self.suggestions]
    return result
...
class Outline(object):
  ...
  def to_json(self):
    ...
    result["length"] = self.length
    if children:
      result["children"] = [Outline.to_json(x) for x in self.children]
    return result
...
class Override(object):
  ...
  def to_json(self):
    ...
    result["length"] = self.length
    if superclassMember:
      result["superclassMember"] = self.superclassMember
    if interfaceMembers:
      result["interfaceMembers"] = [OverriddenMember.to_json(x) for x in self.interfaceMembers]
    return result
...
class SearchResult(object):
  ...
  def to_json(self):
    ...
    result["kind"] = self.kind
    result["isPotential"] = self.isPotential
    result["path"] = [Element.to_json(x) for x in self.path]
    return result
...
class SourceChange(object):
  ...
  def to_json(self):
    result = {}
    result["message"] = self.message
    result["edits"] = [SourceFileEdit.to_json(x) for x in self.edits]
    result["linkedEditGroups"] = [LinkedEditGroup.to_json(x) for x in self.linkedEditGroups]
    if selection:
...
class TypeHierarchyItem(object):
  ...
  def to_json(self):
    result = {}
    result["classElement"] = self.classElement
    if displayName:
      result["displayName"] = self.displayName
    if memberElement:
      result["memberElement"] = self.memberElement
    if superclass:
...
class ExtractMethodFeedback(RefactoringFeedback):
  ...
  def to_json(self):
    ...
    result["parameters"] = [RefactoringMethodParameter.to_json(x) for x in self.parameters]
    result["offsets"] = self.offsets
    result["lengths"] = self.lengths
    return result
